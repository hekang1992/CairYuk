...
class PopAccountView: UIView {
    ...
    lazy var bgImageView: UIImageView = {
        ...
        bgImageView.image = UIImage(named: "out_en_image".localized)
    ...
    override init(frame: CGRect) {
        ...
        bgImageView.snp.makeConstraints { make in
            ...
            make.size.equalTo(CGSize(width: 343.pix(), height: 437.pix()))
        }
